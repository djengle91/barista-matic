  ...
  template: `
    <div class="app-container">
      <div class="sidebar">
        ...
        <div class="inventory-section">
          ...
          <div class="inventory-grid">
            @for (item of getIngredients(); track item.id) {
      ...
      <div class="main-content">
        ...
        <div class="menu-grid">
          @for (drink of getDrinksWithPrices(); track drink.id) {
          <mat-card
            class="drink-card"
            [ngClass]="{ unavailable: !isDrinkAvailable(drink.id) }"
          >
            ...
            <div class="card-footer">
              <button
                ...
                color="primary"
                class="order-button"
                [disabled]="!isDrinkAvailable(drink.id)"
                (click)="dispenseDrink(drink.id)"
              >
                Order
              </button>
            </div>
...
export class AppComponent {
  ...
  getDrinksWithPrices() {
    return this.state.getDrinksWithPrices();
  }

  getDispensing() {
    return this.state.getDispensing();
  }

  restockInventory() {
    this.state.restockInventory();
  }

  dispenseDrink(drinkId: string) {
    this.state.dispenseDrink(drinkId);
  }

  isDrinkAvailable(drinkId: string) {
    return this.state.isDrinkAvailable(drinkId);
  }
}
